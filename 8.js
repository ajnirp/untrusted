...
// keep moving towards the exit. whenever you can't move further, call the phone to regenerate the forest
// the forest generation algorithm ensures that a tree will never be placed in the same location as the player
// sometimes you may need to call the phone multiple times to be able to move forward by a single step, but that's okay