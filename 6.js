...
function startLevel(map) {
    ...
    map.defineObject('defenseDrone', {
        ...
        'onCollision': function (drone) {
            drone.killedBy('my defense drone');
        },
        'behavior': function (me) {
    ...
    // get two drones to surround the attack drone and buy time
    map.placeObject(map.getWidth()-9, 12, 'defenseDrone');
    map.placeObject(map.getWidth()-8, 11, 'defenseDrone');
